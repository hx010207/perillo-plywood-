    ...
    <div className="space-y-4 pb-28 sm:pb-12 max-w-4xl mx-auto text-[#2A1E17] dark:text-[#FAF7F2]">
      ...
      <div className="flex items-center justify-between px-1">
        <div>
          ...
          <p className="text-xs font-semibold text-[#6B5A4E] dark:text-[#C4B5A5] mt-0.5">All submitted purchase invoices and points ledger</p>
        </div>
        <button
      ...
      {loading ? (
        <div className="text-center py-16 bg-[#FAF7F2]/80 dark:bg-[#261C16]/60 rounded-2xl border border-[#8C6D58]/20 text-[#6B5A4E] dark:text-stone-400 text-xs font-semibold">
        ...
        <div className="relative rounded-2xl bg-[#FAF7F2]/90 dark:bg-[#261C16]/90 backdrop-blur-md border border-[#8C6D58]/20 p-12 text-center space-y-3 shadow-lg shadow-stone-900/5 before:absolute before:inset-2 before:border before:border-dashed before:border-[#8C6D58]/30 dark:before:border-[#D9C5B2]/20 before:pointer-events-none before:rounded-xl">
          <div className="relative z-10 space-y-3">
            ...
            <p className="text-xs font-semibold text-[#6B5A4E] dark:text-[#C4B5A5] max-w-sm mx-auto leading-relaxed">
              {t('noClaimsSubText')}
            </p>
          </div>
        </div>
                ...
                <div className="relative z-10 space-y-3">
                  ...
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <p className="text-xs font-semibold text-[#6B5A4E] dark:text-[#C4B5A5] mt-0.5">{dealerCity}</p>
                    ...
                    {item.status === 'Approved' && (
                      <div className="text-right">
                        ...
                        <p className="text-[10px] font-semibold text-[#6B5A4E] dark:text-stone-400 mt-0.5">Credited to wallet</p>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="flex items-center justify-between pt-2 border-t border-[#8C6D58]/15 dark:border-white/10 text-xs">
                    <div>
                      ...
                      <span className="text-[11px] font-medium text-[#6B5A4E] dark:text-[#C4B5A5] ml-2">
