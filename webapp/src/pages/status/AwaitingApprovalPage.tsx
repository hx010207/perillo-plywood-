    ...
    <div className="relative w-full min-h-screen selection:bg-[#8C6D58] selection:text-white">
      ...
      <main className="relative z-10 w-full min-h-screen flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8 text-[#2A1E17] dark:text-[#FAF7F2]">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <div className="relative rounded-3xl bg-[#FAF7F2]/90 dark:bg-[#1A1410]/85 py-8 px-6 shadow-lg shadow-stone-900/5 sm:px-10 border border-[#8C6D58]/25 dark:border-[#8C6D58]/30 text-center backdrop-blur-xl before:absolute before:inset-2 before:border before:border-dashed before:border-[#8C6D58]/20 dark:before:border-white/10 before:pointer-events-none before:rounded-2xl">
            <div className="relative z-10">
              ...
              <button
                ...
                disabled={refreshing}
                className="btn-primary-timber w-full py-3.5 px-4 text-sm font-black rounded-xl shadow-md transition-all active:scale-[0.99] disabled:opacity-70 flex items-center justify-center space-x-2 border-2 border-white/40 cursor-pointer"
              >
              ...
              <button
                onClick={logout}
                className="mt-4 inline-flex items-center text-xs font-bold text-rose-600 dark:text-rose-400 hover:underline cursor-pointer"
              >
